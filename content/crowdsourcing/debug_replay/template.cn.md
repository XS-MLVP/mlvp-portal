...
本期任务将会提供50(待定)个待回归的bug，希望各位能够使用我们的提供的工具链(<a href="https://github.com/XS-MLVP/picker" target="_blank">picker</a>,<a href="https://github.com/XS-MLVP/toffee" target="_blank">toffee</a>(可选))，构建测试用例对bug进行回归，您需要确保用例能够在昆明湖架构不同RTL版本上正常运行。对于大多数的bug，我们会提供详细的bug描述，包括bug所在的模块，发生原因，验证环境等，对于部分bug，可能需要您根据描述定位到产生该bug模块或者搭建验证环境。每完成1个bug的回归并向我们的<a href="https://github.com/XS-MLVP/UnityChipForXiangShan" target="_blank">仓库</a>提交PR，我们将提供100元的奖金作为奖励。希望大家能够积极参与并完成任务！
...
首先，您需要使用<a href="https://github.com/XS-MLVP/picker" target="_blank">picker</a>将出现bug的模块封装为DUT，根据<a href="https://github.com/XS-MLVP/UnityChipForXiangShan" target="_blank">UnityChipForXiangShan</a>所提供的测试环境，构建测试用例对bug进行回归。
