...
本期任务中，合计发布14个子任务，涵盖CPL2的20个子模块，所有的任务都将通过<a href="https://github.com/XS-MLVP/UnityChipForXiangShan/issues" target="_blank">万众一芯之香山处理器的issue</a>分配。 

## 文档编写

本次验证文档众包任务请阅读并理解香山对应模块[代码](https://github.com/OpenXiangShan/XiangShan)后，基于我们提供的[文档模板](https://github.com/XS-MLVP/UnityChipForXiangShan/blob/main/documents/content/zh-cn/docs/98_UT/00_standard/_index.md)完成文档撰写工作并向该仓库提交PR。
